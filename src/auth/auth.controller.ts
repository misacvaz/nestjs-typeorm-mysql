...
import { AuthRegidterDTO } from "./dto/auth.register.dto";
...
import { FileService } from "src/file/file.sevice";
...
export class AuthController{
 ...
 @Post('register')
  async register(@Body() body: AuthRegidterDTO){
 ...
 return {user};
  ...
  @UseGuards(AuthGuard)
  @Post('files')
  async uploadFile(@User() user, @UploadedFiles() files:Express.Multer.File[]) {
    return true
  }
